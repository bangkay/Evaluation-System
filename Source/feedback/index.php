...
<table width="650" height="561"  border="0" align="center" cellpadding="5" cellspacing="5" >
  ...
  <tr>
    <td width="650"  valign="bottom" align="center"><p><b><font size="5" >Faculty Evaluation</font></b></p></td>
  </tr>
  <tr>
	...
	<form action="submit_feedback.php" method="post" name="feedback_form" onsubmit="return chkForm();">
      <table width="711" border="0" align="center">        
		...
		<tr>
          <td width="114">Sutdent ID </td>
          <td width="228"><label>
            <input name="roll_no" type="text" tabindex="1" align="left" onKeyUp="javascript:dodacheck(feedback_form.roll_no);" value=""/>
          </label></td>
          <td width="1">&nbsp;</td>
          <!--<td width="98">Date</td>
          <td width="175"><label>
